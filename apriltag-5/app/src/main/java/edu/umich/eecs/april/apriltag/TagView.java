...
//                        break;
                    ...
                    if (2 * m < 8) {
                        ...
                        for (int i = 0; i < 4; i += 1) {
                            ...
                            corners[2 * i + 0 + cornerCounter]=(float) oX;
                            corners[2 * i + 1 + cornerCounter]=(float) oY;
                        }
...
//                     Draw lines
                ...
                if (mDetections != null) {
                    ...
                    if (mDetections.size() == 2) {
                        ...
                        //Object doubleArray = new double[]{2,slopeFromMethodGreen,x1,y1,x2,y2};

                        messageArray = new double[]{2,slopeFromMethodGreen,x1,y1,x2,y2,
                                corners[0],corners[1],corners[2],corners[3],
                                corners[4],corners[5],corners[6],corners[7],corners[8],corners[9],corners[10],corners[11],

                                corners[12],corners[13],corners[14],corners[15]};

                        mGameHandler.sendMessage(Message.obtain(mGameHandler, 0, messageArray));
                       ...
                       // Object doubleArray = new double[]{alpha, beta, gama};
                        ...
                        messageArray =
                                new double[]{3,alpha,beta,gama,x1,y1,x2,y2,x3,y3,
                        ...
                        double slopeFromMethodGreen =
                                (slopeCalculator(x1 - x2, y1 - y2)) > Math.PI ? 2 * Math.PI - (slopeCalculator(x1 - x2, y1 - y2)) :
                                                                                                    (slopeCalculator(x1 - x2, y1 - y2));
                       ...
                       //Object doubleArray = new double[]{Math.atan(slopeFromMethodGreen), Math.atan(slopeFromMethodBlue)};
                        ...
                        messageArray = new double[]{4,Math.atan(slopeFromMethodGreen), Math.atan(slopeFromMethodBlue),x1,y1,x2,y2,x3,y3,x4,y4,
                                ...
                                corners[24],corners[25],corners[26],corners[27],
